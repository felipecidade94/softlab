...
class SistemaLaboratorio:
    def __init__(self):  # Método inicializador da classe
        ...
        self.texto_embaixo = Label(self.root, text="Por Felipe Cidade Soares e Ivy Oliveira dos Reis", font=("Arial", 10), fg="black", anchor="w") # Cria um texto, à esquerda, na parte de baixo da janela
        self.texto_embaixo.pack(side=BOTTOM, pady=10, fill="x") # Posiciona o texto embaixo e na horizontal
    ...
    def criar_wigets(self):  # Método para criar os widgets da interface
        ...
        style.configure("TButton", padding=15, font=("Arial", 10), foreground="black", background="#add8e6")  # Configura o estilo dos botões
        style.map("TButton",background=[("active", '#00008B')],font=[("active", ("Arial", 11, "bold"))]) # Configura o estilo dos botões quando ativados
    ...
    def registrar_aluno(self):  # Método para registrar um novo aluno
        try:
            ...
            messagebox.showerror("Erro",str("Informe um número de matrícula."))      
        else:
            ...
            try:
                ...
                if nome == "" or nome is None or not nome.isalpha():
                    raise ValueError("Operação cancelada pelo usuário.")
                else:
                    ...
                    messagebox.showerror("Erro",str("Informe o nome do aluno(a). Apenas letras são permitidas."))
