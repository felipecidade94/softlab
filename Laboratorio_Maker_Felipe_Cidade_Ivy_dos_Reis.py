...
class SistemaLaboratorio:
    def __init__(self):  # Método inicializador da classe
        ...
        self.texto_embaixo = Label(self.root, text="Por Felipe Cidade Soares e Ivy Oliveira dos Reis", font=("Arial", 10), fg="blue", anchor="w") # Cria um texto, à esquerda, na parte de baixo da janela
